      ...
      <form class="connect_form create_form" method="post" action="${pageContext.request.contextPath}/encheres/ModifierProfil" >
        ...
        <div class="connect_input">
          ...
          <div class="form_create_section">
            ...
            <input class="form_input" name="prenom" type="text" value="${utilisateur.prenom}" placeholder="Prénom" maxlength="30" required>
          </div>
          <div class="form_create_section">
            <input class="form_input" name="telephone" type="tel" value="${utilisateur.telephone}" placeholder="Téléphone" maxlength="10">
          </div>
