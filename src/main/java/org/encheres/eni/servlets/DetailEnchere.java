...
public class DetailEnchere extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Article articleConsulte = new Article("PC Gamer", "Un PC le voilà qu'il est beau et propre (DD non fournit, cables en options)", LocalDateTime.of(2022, Month.SEPTEMBER, 1, 16, 30),
				LocalDateTime.of(2023, Month.MARCH, 5, 20, 35), 100, 250, 5, 1);
